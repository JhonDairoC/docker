...
from .import views
from .views import EditProductAPIView, CreateProduct, DeletePorduct, CommentCreate, ProductoList, RespcommentCreate, UpdateProduct
...
urlpatterns = [
    ...
    path('orden/<str:product_id>/', UpdateProduct.as_view(), name='orden'),
