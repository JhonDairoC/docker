...
class Mensage(APIView):
    def post(self, request, nameReceptor):
        ...
        notification = {
            ...
            'sound': 'https://firebasestorage.googleapis.com/v0/b/colveg-67dae.appspot.com/o/notificacion%2FnotificacionChat.mp3?alt=media&token=e0d5e291-7197-468b-b5c0-0f763b3470cb',
            'message_icon': 'logo1.jpg',
            'click_action': 'http://localhost:62225/#/',
            'color': RGB(34, 40, 49),  # Establecer el color de fondo de la notificación (rojo en este caso)
            'badge': 1  # Agregar un número de insignia (badge) a la notificación
        }

        response = fcm.notify_single_device(
            registration_id=idMensajesChat,
            **notification,
        )
...
#                 'Authorization': 'Bearer AAAAoh0jA4A:APA91bF9iuZrmqjRTCnYAo48nLTnuLUQ5qdqufy_2Ws9GwD88cEIPYDXQiwwrdUUsV9bF3nqM_ktr4vGnWcv_NfGmKXpLCYmbFgHIjDoDkKGfCcM--GKg20tJwEZXP32SqfC3F092aCr'
#             }

#             data = {
#                 'data': {
#                     'key': 'AAAAoh0jA4A:APA91bF9iuZrmqjRTCnYAo48nLTnuLUQ5qdqufy_2Ws9GwD88cEIPYDXQiwwrdUUsV9bF3nqM_ktr4vGnWcv_NfGmKXpLCYmbFgHIjDoDkKGfCcM--GKg20tJwEZXP32SqfC3F092aCr'
#                 },
#                 'content_available': True,
#                 'notification': {
#                 'sound': 'notificacionChat.mp3',
#                 'icon': 'logo1.jpg',
#                 'color': '#FF0000',
#                 'title': userName,
#                 'body': mensaje
...
#             return JsonResponse({'Notificación enviada:': response.text}, status=200)